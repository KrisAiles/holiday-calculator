...
proRataHoursForm.addEventListener("submit", (e) => {
    ...
    if (ptHpw > hpw) {
        return alert("Part time hours can't be more than full time equivalent hours.");
    }
    ...
    async function calculateHolidayEntitlement(startMonth) {
        ...
        } else if (ftHolEnt - ftHolEntTrunc > 0.5 && ftHolEnt - ftHolEntTrunc < 1) {
            ftHolEntProRata = ftHolEntTrunc + 1;
        } else {
            ftHolEntProRata = ftHolEntTrunc;
        };
